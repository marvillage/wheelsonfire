...
<link rel="stylesheet" href="sell.css"></link>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  echo "<h1>Listed Car:</h1>";
  echo "<p><strong>Make:</strong> " . $carMake . "</p>";
  echo "<p><strong>Model:</strong> " . $carModel . "</p>";
  echo "<p><strong>Year:</strong> " . $carYear . "</p>";
  echo "<p><strong>Price:</strong> " . $carPrice . "</p>";
  echo "<p><strong>Description:</strong> " . $carDescription . "</p>";
}
?>
<div class="foot1">
<!-- Footer -->
